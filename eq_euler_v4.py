...
ax3d_final.legend()
fig_3d.savefig('figura_3d_v4.png')
plt.close(fig_3d)
...
plt.legend()
plt.grid(True)
plt.savefig('figura_omega_cuerpo_v4.png')
plt.close()
...
# Guardar como video
print("Guardando video 'simulacion_euler_v4.mp4'...")
try:
    writer = FFMpegWriter(fps=30, metadata=dict(artist='Me'), bitrate=1800)
    ani.save('simulacion_euler_v4.mp4', writer=writer)
    ...
    ani.save('simulacion_euler_v4.mp4', fps=30)
